# Bypass PowerShell execution policy - not required
...
# ------------------------------------------
# Create function for grabbing SMTP Server
# ------------------------------------------
...
# ------------------------------------------
# Find the default mail server for the 
# current user
# ------------------------------------------

write-host "Finding SMTP server..."

# Grab SMTP server
$MailServer = Get-SPN -type service -search "smtp*" | select name -First 1 -ExpandProperty name

# Set the mail server for use
$smtp = New-Object Net.Mail.SmtpClient("$MailServer")

# ------------------------------------------
# Send the testing emails
# ------------------------------------------

write-host "Sending test emails..."

# Send emails containing sample card numbers and socials
# Note: You can use the following card numbers to test transactions in the test environment only. 
# When using test cards, you can specify an expiry date up to seven years in the future. The test 
# cards do not have a card verification code and issue number.

$smtp.Send("emailtest@clientdomain.com","consultant@netspi.com","Test Email - SSN 1","123-45-6789")
$smtp.Send("emailtest@clientdomain.com","consultant@netspi.com","Test Email - SSN 2","123.45.6789")
$smtp.Send("emailtest@clientdomain.com","consultant@netspi.com","Test Email - SSN 3","123456789")
$smtp.Send("emailtest@clientdomain.com","consultant@netspi.com","Test Email - Credit Card Amex 1","American Express 378282246310005")
$smtp.Send("emailtest@clientdomain.com","consultant@netspi.com","Test Email - Credit Card Amex 2","American Express 371449635398431")
$smtp.Send("emailtest@clientdomain.com","consultant@netspi.com","Test Email - Credit Card Amex 3","American Express Corporate 378734493671000")
$smtp.Send("emailtest@clientdomain.com","consultant@netspi.com","Test Email - Credit Card Austr 1","Australian BankCard 5610591081018250")
$smtp.Send("emailtest@clientdomain.com","consultant@netspi.com","Test Email - Credit Card Diners 1","Diners Club 30569309025904")
$smtp.Send("emailtest@clientdomain.com","consultant@netspi.com","Test Email - Credit Card Diners 2","Diners Club 38520000023237")
$smtp.Send("emailtest@clientdomain.com","consultant@netspi.com","Test Email - Credit Card Disco 1","Discover 6011111111111110")
$smtp.Send("emailtest@clientdomain.com","consultant@netspi.com","Test Email - Credit Card Disco 2","Discover 6011000990139420")
$smtp.Send("emailtest@clientdomain.com","consultant@netspi.com","Test Email - Credit Card JCB 1","JCB 3530111333300000")
$smtp.Send("emailtest@clientdomain.com","consultant@netspi.com","Test Email - Credit Card JCB 2","JCB 3566002020360500")
$smtp.Send("emailtest@clientdomain.com","consultant@netspi.com","Test Email - Credit Card JCB 2","JCB 3566002020360500")
$smtp.Send("emailtest@clientdomain.com","consultant@netspi.com","Test Email - Credit Card Master 1","MasterCard 5555555555554440")
$smtp.Send("emailtest@clientdomain.com","consultant@netspi.com","Test Email - Credit Card Master 2","MasterCard 5105105105105100")
$smtp.Send("emailtest@clientdomain.com","consultant@netspi.com","Test Email - Credit Card Maestro 1","Maestro 6799990100000000019")
$smtp.Send("emailtest@clientdomain.com","consultant@netspi.com","Test Email - Credit Card Visa 1","Visa 4111111111111110")
$smtp.Send("emailtest@clientdomain.com","consultant@netspi.com","Test Email - Credit Card Visa 2","Visa 4012888888881880")
$smtp.Send("emailtest@clientdomain.com","consultant@netspi.com","Test Email - Credit Card Visa 3","Visa 4222222222222")
$smtp.Send("emailtest@clientdomain.com","consultant@netspi.com","Test Email - Credit Card Visa Deb 1","Visa Debit 4917610000000000003")
write-host "done."
