 <#
	...
	.DESCRIPTION
	This script can be used to query sql servers and view the results with sql logins credentials, a trusted connection, 
	or altenrative domain credential for both trusted and untrusted domains.
