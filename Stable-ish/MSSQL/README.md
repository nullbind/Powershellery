...
|Get-SQLInstanceDomain	       |Returns SQL Server instances from LDAP query results. Searches based on SPNs and UDP scanning of management servers. Will default to current user's domain, but domain,user,and password can be provided for alternative domains.|Complete|
